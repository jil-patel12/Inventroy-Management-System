<?php
    $purchaseOrderId = $_GET["purchaseId"];
    include("delete-purchase-order-function.php");
        ...
        <div class="col-12">
         <div class="card card-primary card-outline">
            <div class="card-header">
              <h3>Purchase Order Delete Fail</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <h4>Purchase Order Delete of purchase order id: <?php echo $purchaseOrderId; ?> due to function failure.</h4>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
