<?php
    ...
    session_start();
    ob_start();
    include("view-purchase-order-function.php");
        ...
        <div class="col-12">
         <div class="card card-primary card-outline">
            <div class="card-header">
              <h3>View Purchase Order Details
			  </h3>
            </div>
            <div class="card-header">
              <h4>Purchase Id: <?php echo $purchaseId; ?></h4>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                    fetchPurchaseOrderDetails($purchaseId);
                  ?> 
                </tbody>
              </table>
            </div>
