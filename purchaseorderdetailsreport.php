  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Purchase Order Details Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Purchase Order Details Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                <form id="report" action="purchaseorderdetailsreport.php" method="post">
                  <!-- Date range -->
                  ...
                  <div class="form-group">
                    <?php
                      if(isset($_POST["generatereport"])){
                        ...
                        header("location:print-report.php?reportType=purchaseorderdetails&startDate=$startDate&endDate=$endDate");
                      }
                    ?>
