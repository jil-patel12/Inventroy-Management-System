            ...
            <div class="card">
              ...
              <form action="purchaseaddcode.php" method="post" id="purchasefrm" role="form" enctype="multipart/form-data">
                <div class="card-body">				
				  ...
				  <div class="form-group">
                      <label class="col-md-12">Purchase Order No:</label>
					  <div class="col-md-6">
					  <button type="button" class="btn bg-gradient-primary" id="gchallan" onclick="generateChallan(this.id);"><i class="fas fa-plus-circle"></i> Generate Purchase</button>
				  ...
				  <div class="form-group">
                    <label class="col-md-12">Bill Amount</label>
					 <div class="col-md-6">
				  ...
				  <div class="form-group">
                    <label class="col-md-12">Discount</label>
					 <div class="col-md-6">
                    <input type="text" name="discount" class="form-control" id="discount" placeholder="for e.g 10%" required>
					</div>
                  </div>
				  <div class="form-group">
                ...
                <div class="card-footer">
                  <input type="submit" name="purchase_add" class="btn btn-primary btn-lg" value="Submit Purchase">
