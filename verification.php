...
if(isset($_POST['submit'])){
	...
	$sql ="SELECT * FROM admin_master where code='$code'";
...
<head>
  ...
  <title>Peedee Electronics - Admin | Verification Code</title>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="#" method="post">
        ...
        <div class="row">
          <div class="col-12">
            <input type="submit" name="submit" value="Verify" class="btn btn-primary btn-block"></input>
          </div>
          <!-- /.col -->
        </div>
      </form>
