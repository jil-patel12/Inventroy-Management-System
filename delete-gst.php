<?php
    ...
    session_start();
    ob_start();
    include("delete-gst-function.php");
    if(deleteGSTPercentage($gstId)){
...
<head>
  ...
  <title>GST Percentage ERROR</title>
        ...
        <div class="col-12">
         <div class="card card-primary card-outline">
            <div class="card-header">
              <h3>GST Percentage Delete Fail</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <h4>GST Percentage Delete of id: <?php echo $gstId; ?> due to function failure.</h4>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
