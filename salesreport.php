...
<head>
  ...
  <title>Peedee Electronics - Sales Report</title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                <form id="report" action="salesreport.php" method="post">
                  <!-- Date range -->
                  ...
                  <div class="form-group">
                    <?php
                      if(isset($_POST["generatereport"])){
                        ...
                        header("location:print-report.php?reportType=salesorder&startDate=$startDate&endDate=$endDate");
                      }
                    ?>
