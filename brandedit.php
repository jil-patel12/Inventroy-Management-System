...
$actived="brand";
	...
	if(!empty($_GET['id'])) {
		$id = $_GET['id'];
		$sql1 = mysqli_query($con,"SELECT * FROM brand_master where brand_id='$id'") or die (mysqli_error($con));
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="brandeditcode.php" method="post" role="form">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputBrand">Brand name</label>
                    <input type="text" name="brand_name" value="<?php echo $row['brand_name']; ?>" class="form-control" id="exampleInputBrand1" placeholder="Brand Name">
                ...
                <div class="card-footer">
                  <button type="submit" name="brand" class="btn btn-primary">Submit</button>
				  <!--<strong>|</strong>*-->
