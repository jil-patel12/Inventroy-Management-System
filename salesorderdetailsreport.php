...
<head>
  ...
  <title>Peedee Electronics - Sales Order Details Report</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Sales Order Details Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Sales Order Details Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                <form id="report" action="salesorderdetailsreport.php" method="post">
                  <!-- Date range -->
                  ...
                  <div class="form-group">
                    <?php
                      if(isset($_POST["generatereport"])){
                        ...
                        header("location:print-report.php?reportType=salesorderdetails&startDate=$startDate&endDate=$endDate");
                      }
                    ?>
