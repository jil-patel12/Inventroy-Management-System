          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><i class="fas fa-plus"></i> Add Unit</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="unitaddcode.php" method="post" role="form">
                <div class="card-body">
                ...
                <div class="card-footer">
                  <input type="submit" name="unit_add" class="btn btn-primary">
